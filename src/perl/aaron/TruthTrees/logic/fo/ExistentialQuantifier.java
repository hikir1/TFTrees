...
public class ExistentialQuantifier extends A_Quantifier {
	public static final String TYPE_NAME = "Existential Quantifier";
	public static final String SYMBOL = "\u2203";

	public ExistentialQuantifier(Variable v, I_Statement s, Map<Constant,List<I_Statement>> statementsWithConstant) {
	...
	public void subVerifyDecomposition(List<List<I_Statement>> branches) throws UserError {
		...
		I_Statement decomposed = branches.get(0).get(0);
		try {
